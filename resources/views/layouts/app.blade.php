...
<body style="background-color: beige;">
    <div id="app">
                        ...
                        @else
                            ...
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    @if (Auth::user()->img != 1)
                                    <img src="/storage/{{Auth::user()->img}}" alt="foto de perfil" id="imgPerfil" height="40p" >
                                    @endif
                                    {{ Auth::user()->name }}
                                </a>
        ...
        <footer id="footer" class="footer-1">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3">
                                <div class="widget subscribe no-box">
                                    <h5 class="widget-title">QUIEN SOY<span></span></h5>
                                    <p class="elp">Soy Matias Martinelli, un estudiante de Programacion Web al que le gusta viajar y compartir sus historias en este blog. </p>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3">
                                ...
                                <li>
                                <div class="thumb-content"><a href="/register">Registro</a></div>	
                                </li>
                                <li>
                            ...
                            <p class="elp">Get access to your full Training and Marketing Suite.</p>
                            ...
                            <p class="elp"><a href="mailto:info@domain.com" title="glorythemes">matiasmartinelli12@gmail.com</a></p>
                ...
                <p class="elp">Copyright Matias Martinelli © 2019. Todos los Derechos Reservados.</p>
                </div>
                </div>
                </div>
                </div>
